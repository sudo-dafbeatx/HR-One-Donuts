  ...
  return (
    <div className="flex flex-col gap-4 mb-10">
      <div className="flex flex-col gap-2">
        <span className="text-primary font-semibold tracking-wide text-xs uppercase">Menu Kami</span>
        <h1 className="text-heading text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight">
