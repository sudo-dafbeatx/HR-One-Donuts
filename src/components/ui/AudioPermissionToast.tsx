...
export default function AudioPermissionToast() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-1/2 md:-translate-x-1/2 md:w-full md:max-w-md bg-white rounded-2xl shadow-2xl border border-primary/20 p-4 z-100 animate-in slide-in-from-bottom-5 fade-in duration-500">
