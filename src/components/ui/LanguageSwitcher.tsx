...
export default function LanguageSwitcher() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 w-48 bg-white rounded-2xl shadow-xl border border-slate-100 p-1.5 animate-in fade-in slide-in-from-top-2 duration-200 z-60">
          {languages.map((lang) => (
            <button
              key={lang.code}
              onClick={() => {
