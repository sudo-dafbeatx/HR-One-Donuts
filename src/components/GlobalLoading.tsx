...
export default function GlobalLoading({ isVisible, message = 'Please wait ...' }: GlobalLoadingProps) {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-[100dvh] z-9999 flex flex-col items-center justify-center bg-white/90 backdrop-blur-md transition-all duration-300">
