...
export default function ChatbotWidget() {
  ...
  const hiddenRoutes = ['/admin', '/login', '/register', '/onboarding', '/settings/help', '/terms', '/privacy', '/cookies'];
    ...
    <>
      ...
      {!isOpen && (
        ...
        >
          {/* Hint Bubble */}
          {showHint && (
            <div className="absolute bottom-full right-0 mb-4 animate-[bounce_2s_infinite] pointer-events-auto z-9999 origin-bottom-right drop-shadow-2xl max-w-[calc(100vw-5rem)]">
              <div className="bg-white text-slate-800 px-4 py-2.5 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-2 whitespace-nowrap">
