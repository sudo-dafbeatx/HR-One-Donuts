  ...
  const products = [
    {
      ...
      name: "Classic Glazed",
      price: 12000,
      description: "The timeless favorite, perfectly soft dough with a signature honey glaze.",
    ...
    },
    {
      ...
      price: 15000,
      description: "Indulgent dark chocolate ganache topped with belgian chocolate shavings.",
    ...
    },
    {
      ...
      name: "Lotus Biscoff",
      price: 18000,
      description: "Stuffed with cookie butter cream and topped with Biscoff crumble.",
    ...
    },
    {
      ...
      price: 15000,
      description: "Fresh strawberry icing made from real berries with white chocolate drizzle.",
    ...
    },
    {
      ...
      price: 22000,
      description: "Creamy pistachio glaze topped with roasted Sicilian pistachios.",
    ...
    },
    {
      ...
      name: "Nutella Heaven",
      price: 20000,
      description: "Exploding with Nutella filling and dusted with fine icing sugar.",
    ...
    },
    {
      ...
      price: 15000,
      description: "Wild blueberry preserve filling with a light vanilla icing.",
    ...
    },
    {
      ...
      name: "Cinnamon Sugar",
      price: 12000,
      description: "Classic ring donut tossed in a warm cinnamon and sugar mix.",
