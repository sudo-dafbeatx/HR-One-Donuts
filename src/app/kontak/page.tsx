        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-slate-600 leading-relaxed">
            <div className="space-y-10">
              ...
              <section>
                ...
                <div className="pl-9">
                  ...
                  <a 
                    href={`https://wa.me/${process.env.NEXT_PUBLIC_CONTACT_WA_NUMBER || '6285810658117'}`} 
                    target="_blank" 
            ...
            <div className="bg-primary/5 rounded-4xl p-8 md:p-10 border border-primary/10 flex flex-col justify-center text-center space-y-6">
              ...
              <Link 
                href={`https://wa.me/${process.env.NEXT_PUBLIC_CONTACT_WA_NUMBER || '6285810658117'}?text=Halo%20saya%20ingin%20memberikan%20saran`}
                target="_blank"
