...
export default function PoliciesPage() {
  ...
  const policies = [
    ...
    { label: "Kebijakan Privasi HR-One Donuts", href: "#" },
    { label: "Kebijakan Privasi (Detail Pengumpulan Data)", href: "#" },
    { label: "Persyaratan Layanan Event Ulang Tahun", href: "#" },
    { label: "Persyaratan Flash Sale: SMS", href: "#" },
    { label: "Persyaratan Flash Sale: Jum'at Berkah", href: "#" },
    { label: "Ketentuan Donat Box", href: "#" },
    { label: "Ketentuan Donat Eceran", href: "#" }
  ];
    ...
    <div className="space-y-6 px-4 py-8 pb-32">
      ...
      <div className="pt-8 space-y-4">
         ...
         <div className="space-y-2">
            <ContactLink label="Chat Sistem" href="#" />
            <ContactLink label="Email: halo@hrone.com" href="mailto:halo@hrone.com" />
